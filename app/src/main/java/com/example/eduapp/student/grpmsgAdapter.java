...
public class grpmsgAdapter extends RecyclerView.Adapter {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if (viewType == 0) {
            return new vh2(LayoutInflater.from(context).inflate(R.layout.grpsinglerow2, parent, false));
        } else {
            return new vh1(LayoutInflater.from(context).inflate(R.layout.grpsinglerow1, parent, false));
        }
    }
